...
class GlassPresets {
  ...
  static const GlassThemePreset glass = GlassThemePreset(
    ...
    dark: GlassColorTokens(
      ...
      skeletonBase: Color(0x14FFFFFF),
      skeletonHighlight: Color(0x2BFFFFFF),
    ...
    light: GlassColorTokens(
      ...
      divider: Color(0x142F3550),
      hoverFill: Color(0x0F1A1F3C),
      skeletonBase: Color(0x12242A4A),
      skeletonHighlight: Color(0x59FFFFFF),
